                ...
                <div class="premium-header">
                    <div class="d-flex align-items-center">
                        <div class="position-relative me-4">
                            <i class="fas fa-plus-circle fa-3x text-white opacity-75"></i>
                            <i class="fas fa-pen position-absolute" style="font-size: 14px; top: 50%; left: 50%; transform: translate(-50%, -50%);"></i>
                        </div>
                        <div>
                            <h3 class="mb-1 fw-bold text-primary">Thêm Sản Phẩm Mới</h3>
                            <p class="mb-0 text-primary-50">Tạo bài viết mới cho website của bạn</p>
                        </div>
                    </div>
                </div>
                
                <div class="card-body p-4 p-lg-3">
                    <form action="{{ route('new.store') }}" method="POST" enctype="multipart/form-data" id="productForm">
                        @csrf
                        ...
                        <div class="mb-4 pb-2">
                            ...
                            <div class="shadow-sm">
                                ...
                                <textarea class="form-control @error('outstanding') is-invalid @enderror" 
                                         ...
                                         name="outstanding" 
                                         rows="5" 
                                         placeholder="Mô tả ngắn gọn về nội dung chính của bài viết...">{{ old('outstanding') }}</textarea>
                            </div>
                            @error('outstanding')
                                <div class="invalid-feedback ps-1">
                                    <i class="fas fa-exclamation-circle me-1 text-danger"></i> {{ $message }}
                        ...
                        <div class="mb-4 pb-2">
                            ...
                            <div class="image-upload-area" id="uploadArea">
                                <div class="py-3 d-flex flex-column align-items-center">
                                    ...
                                    <h5 class="mb-2">Kéo thả hoặc chọn ảnh</h5>
                                    ...
                                    <div class="position-relative">
                                        <button type="button" class="btn btn-primary px-4" id="uploadButton">
                                            <i class="fas fa-images me-2"></i>Chọn ảnh
                                        </button>
                                        <input type="file" 
                ...
                <div class="preview-container">
                    ...
                    <div class="bg-light p-3 border-top">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="mb-1 text-truncate" style="max-width: 250px;">${file.name}</h6>
